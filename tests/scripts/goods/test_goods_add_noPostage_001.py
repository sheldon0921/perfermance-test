...
@allure.feature('商品')
class Test_goods_add_noPostage_001(object):
    ...
    def ini(self):
        ...
        self.addSpecTemplateParam = ReaderFile.readerJson("addSpecTemplate.json")
        self.addGoodsParam = ReaderFile.readerJson("addGoodsNoPostage.json")
        # self.addGoodsParam["postage"][0]["is_open"] = False
        # self.addGoodsParam["sku"][0]["postage"][0]["is_open"] = False
    ...
    def test_goods_add_noPostage(self, ini):
        # 保存商品信息
        addGoodsRes = self.goods.addGoods("", self.addSpecTemplateParam, self.addGoodsParam)
