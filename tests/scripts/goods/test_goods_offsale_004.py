...
class Test_goods_add_publish_onsale_goods(object):
    ...
    @allure.story('新增并上架单sku商品，可以下架成功，且为待上架列表第一条')
    @pytest.mark.smoke
    def test_goods_offsaleGoods(self, ini):
        ...
        # 查询待上架商品列表的第一条数据
        goodlistParam ={"searchType": 4, "searchParams": {"searchString": {"keyword": str(self.spuId), "type": 4},"searchGoodsStatus": 0,"searchSort": {"sortColumn": 0, "sortType": 0}}, "page": 1,"size": 10}
